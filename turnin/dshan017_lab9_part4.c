 ...
 *
 *	Demo Link: https://drive.google.com/file/d/1AGzBrSvA4fKYU10S_K4pBZfGphd1qhbH/view?usp=drivesdk
 */
#include <avr/io.h>
...
enum FrequencyAdjusterSM { FA_Start, FA_Wait, FA_Up, FA_Down } FA_State;
