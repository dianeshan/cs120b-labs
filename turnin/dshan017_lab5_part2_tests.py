...
tests = [ {'description': 'PINA: 0x01, 0x00, 0x03 => PORTC: 0x00, BT_state: BT_reset',
    'steps': [ {'inputs': [('PINA', 0x01)], 'iterations': 1 },
        {'inputs': [('PINA', 0x00)], 'iterations': 1},
        {'inputs': [('PINA', 0x03)], 'iterations': 1}],
        'expected': [('PORTC', 0x00)],
    },
    {'description': 'PINA: 0x01 => PORTC: 0x01, BT_state: BT_incp',
        'steps': [{'inputs': [('PINA', 0x01)], 'iterations': 1} ],
        'expected': [('PORTC', 0x00)],
    },
    {'description': 'PINA: 0x01, 0x01, 0x01, 0x02 => PORTC: 0x03, BT_state: BT_decr',
        'steps': [ {'inputs': [('PINA', 0x01)], 'iterations': 1 },
