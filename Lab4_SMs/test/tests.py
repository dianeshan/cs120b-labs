...
tests = [ {'description': 'PINA: 0x04, 0x02, 0x00 => PORTB: 0x01, BT_state: BT_unlocked',
    ...
    {'description': 'PINA: 0x04, 0x06, 0x00, 0x03 => PORTB: 0x00, BT_state: BT_locked',
    'steps': [ {'inputs': [('PINA',0x04)], 'iterations': 2 },
    ...
    {'description': 'PINA: 0x04, 0x06, 0x04, 0x00, 0x02 => PORTB: 0x01, BT_state: BT_unlocked',
    'steps': [ {'inputs': [('PINA',0x04)], 'iterations': 2 },
                {'inputs': [('PINA', 0x06)], 'iterations': 2},
