...
int main(void)
{
    ...
    task6.TickFct = &lose_tick;

    task7.state = start;
    task7.period = 1;
    task7.elapsedTime = task7.period;
    task7.TickFct = &display_tick;
